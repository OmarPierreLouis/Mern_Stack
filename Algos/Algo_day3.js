...
function merge(arr1, arr2) {
    ...
    let i = 0; 
    let j = 0; 
    // loop through the array compare which array has the smaller value at their current index 
    // whichever array has the smaller value, put the value into the result 
    // incrument the iterator of the array that has a smaller value 
}
